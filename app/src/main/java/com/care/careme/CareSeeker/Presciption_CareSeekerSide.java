...
public class Presciption_CareSeekerSide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_presciption_careseeker_side);
        ...
        CareSeeker_Session_Management session = new CareSeeker_Session_Management(Presciption_CareSeekerSide.this);
    ...
    private void send_prescription_over_mail() {
        ...
        View view = LayoutInflater.from(Presciption_CareSeekerSide.this).inflate(R.layout.prescription_over_mail, null);
        final EditText emailText = view.findViewById(R.id.emailEt);
        Button get = view.findViewById(R.id.send_email);
        final AlertDialog.Builder builder = new AlertDialog.Builder(Presciption_CareSeekerSide.this);
        ...
        get.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(emailid)){
                    Toast.makeText(Presciption_CareSeekerSide.this, "Enter Your email id...", Toast.LENGTH_SHORT).show();
                    return;
                }
                message="";
                if(!date_data.isEmpty()){
                    message=message+"\n \nDate of Service: "+ date_data;
                }
                else {
                    message=message+"\n \nDate of Service: "+ "-";
                }
                ...
                if(!Consultation_type_data.isEmpty()){
                    message=message+"\n\n Service Type: "+ Consultation_type_data;
                }
                else {
                    message=message+"\n \nService Type: "+ "-";
                }
                ...
                if(!Previous_Lab_reports_data.isEmpty()){
                    message=message+"\n \n Previous Report: "+ Previous_Lab_reports_data;
                }
                else {
                    message=message+"\n\n Previous Report: "+ "-";
                }
                ...
                try {
                    ...
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, " Service report of  "+ " " +date + " "+ "by : " + dname);
                    emailIntent.putExtra(Intent.EXTRA_TEXT, message);
                    startActivity(Intent.createChooser(emailIntent, "Sending email..."));


                } catch (Throwable t) {
                    Toast.makeText(Presciption_CareSeekerSide.this, "Request failed try again: "+ t.toString(), Toast.LENGTH_LONG).show();
                }
