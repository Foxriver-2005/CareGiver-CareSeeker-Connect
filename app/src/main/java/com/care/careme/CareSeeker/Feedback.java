...
import com.care.careme.Models.Feedback_Model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prescription = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Prescription_By_CareGiver");
                user = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Users");
                ...
                Intent intent = new Intent(Feedback.this, CareSeeker_side_prescription_recycler.class);
