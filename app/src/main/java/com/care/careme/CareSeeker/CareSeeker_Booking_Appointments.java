...
public class CareSeeker_Booking_Appointments extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_careseeker_booking_appointments);
        ...
        email = email.replace(".", ",");
        CareSeeker_Session_Management session = new CareSeeker_Session_Management(CareSeeker_Booking_Appointments.this);
        ...
        String[] monthName = {"Jan", "Feb",
                ...
                "Aug", "Sep", "Oct", "Nov",
                "Dec"};
        date_val = DateFormat.format("d MMM yyyy", startDate).toString();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    if(dates.size() == 0 && isIsresumed()) {
                        Toast.makeText(CareSeeker_Booking_Appointments.this, "No Slots Available!", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        horizontalCalendar.setCalendarListener(new HorizontalCalendarListener() {
            ...
            public void onDateSelected(Calendar date, int position) {
                date_val = DateFormat.format("d MMM yyyy", date).toString();
                chosen_time = "";
                time_view.setText("");
                reference_booking.child(email).child(date_val).addValueEventListener(new ValueEventListener() {
                    @Override
        ...
        book_app.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(chosen_time.equals("")){
                    Toast.makeText(CareSeeker_Booking_Appointments.this, "Please Select the Time Slot!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(pname.isEmpty()){
                    patient_name.setError("CareSeeker's Name is a required field");
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()) {
                            ...
                            if (booking.getValue() == 1) {
                                Toast.makeText(CareSeeker_Booking_Appointments.this, "The Slot is already Booked. Please Choose other Slot!", Toast.LENGTH_SHORT).show();
                                return;
                                ...
                                Intent intent = new Intent(CareSeeker_Booking_Appointments.this, CareSeeker_Payment_Appt.class);
                            ...
                            Toast.makeText(CareSeeker_Booking_Appointments.this, "The Care Giver is not available! Select other slot!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
