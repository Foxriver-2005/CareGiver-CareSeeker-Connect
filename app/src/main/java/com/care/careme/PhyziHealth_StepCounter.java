...
import com.care.careme.Helpers.StepCounter_Service;
...
public class PhyziHealth_StepCounter extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        reference_fitness = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Fitness");
        Care_Seeker_Session_Management session = new Care_Seeker_Session_Management(PhyziHealth_StepCounter.this);
