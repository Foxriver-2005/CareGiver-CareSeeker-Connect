...
public class CareSeeker_MessageAdapter extends RecyclerView.Adapter<CareSeeker_MessageAdapter.ViewHolder> {
    ...
    public CareSeeker_MessageAdapter(Context mContext, List<Chat> mChat, String imageurl, String emailID) {
    ...
    public int getItemViewType(int position) {
        CareSeeker_Session_Management session = new CareSeeker_Session_Management(mContext);
