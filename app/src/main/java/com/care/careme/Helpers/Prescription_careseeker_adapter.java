...
import com.care.careme.CareSeeker.Feedback;
import com.care.careme.CareSeeker.Presciption_CareSeekerSide;
import com.care.careme.Models.Get_Prescription_Details;
import com.care.careme.R;

import java.util.ArrayList;

public class Prescription_careseeker_adapter extends RecyclerView.Adapter<Prescription_careseeker_adapter.ViewHolder> {

    private ArrayList<Get_Prescription_Details> get_prescription_details;
    private Context mContext;

    public Prescription_careseeker_adapter(ArrayList<Get_Prescription_Details> get_prescription_details, Context mContext) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(obj.getFlag() == 0){
                    ...
                    Intent intent = new Intent(view.getContext(), Presciption_CareSeekerSide.class);
