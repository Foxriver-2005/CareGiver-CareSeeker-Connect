...
import com.care.careme.CareSeeker.CareSeeker_Display_CareGiver;
...
public class CareGiver_Adapter extends RecyclerView.Adapter<CareGiver_Adapter.ViewHolder> {
    ...
    public CareGiver_Adapter(List<CareGiver_Profile> listData, List<String> emaildata, Context mContext) {
    ...
    @NonNull
    @Override
    public CareGiver_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(view.getContext(), CareSeeker_Display_CareGiver.class);
    ...
    @Override
    public void onBindViewHolder(@NonNull CareGiver_Adapter.ViewHolder holder, int position) {
