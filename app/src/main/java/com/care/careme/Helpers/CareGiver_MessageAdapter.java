...
public class CareGiver_MessageAdapter extends RecyclerView.Adapter<CareGiver_MessageAdapter.ViewHolder> {
    ...
    public CareGiver_MessageAdapter(Context mContext, List<Chat> mChat, String imageurl, String emailID) {
