...
import com.care.careme.Helpers.CareGiver_View_Slots_Adapter;
import com.care.careme.Helpers.CareGiver_Session_Mangement;
import com.care.careme.Models.Booking_Appointments;
import com.care.careme.Models.CareGiver_Slots_Time;
import com.care.careme.R;

import java.util.ArrayList;
import java.util.Calendar;

public class CareGiver_ChooseSlots extends AppCompatActivity {
    ...
    private CareGiver_View_Slots_Adapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caregiver_choose_slots);
        ...
        Toast.makeText(CareGiver_ChooseSlots.this, "Swipe to cancel the slots from the chosen!", Toast.LENGTH_LONG).show();
        ...
        reference_appt = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("CareGiver_Appointments");
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(CareGiver_ChooseSlots.this));
        ...
        start_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (chosen_date.equals("")) {
                    Toast.makeText(CareGiver_ChooseSlots.this, "Select Date First", Toast.LENGTH_SHORT).show();
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (chosen_date.equals("")) {
                    Toast.makeText(CareGiver_ChooseSlots.this, "Select Date!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (start_data.equals("") || start_data.equals("Start Time")) {
                    Toast.makeText(CareGiver_ChooseSlots.this, "Choose Start Time!", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (end_data.equals("") || end_data.equals("End Time")) {
                    Toast.makeText(CareGiver_ChooseSlots.this, "Choose End Time!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                reference_booking.child(email).child(chosen_date).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            if (flag == 1) {
                                Toast.makeText(CareGiver_ChooseSlots.this, "You have already booked slot in this Time Frame", Toast.LENGTH_SHORT).show();
                                return;
                            } else {
                                int slots = (end - start) * 2;
                                String date = "";
                                CareGiver_Slots_Time time = new CareGiver_Slots_Time(String.valueOf(start), String.valueOf(end));
                                ...
                                Toast.makeText(CareGiver_ChooseSlots.this, "Slots Chosen!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            int slots = (end - start) * 2;
                            String date = "";
        ...
        reference_booking.child(email).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    adapter = new CareGiver_View_Slots_Adapter(CareGiver_ChooseSlots.this, doctor_slots, date_slot, count);
