...
public class PrescriptionActivity extends AppCompatActivity {
    ...
    public void send_prescription(View view) {
        ...
        Toast.makeText(PrescriptionActivity.this, "Service Uploaded Successful!", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(PrescriptionActivity.this, CareGiver.class));
