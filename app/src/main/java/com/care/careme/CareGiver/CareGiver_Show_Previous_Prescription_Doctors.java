...
public class CareGiver_Show_Previous_Prescription_Doctors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caregiver_show_previous_prescription_doctors);
