...
//
                                            Intent intent = new Intent(getApplicationContext(), CareSeeker.class);
                                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                            startActivity(intent);
                                            CareSeeker_Phone_No patientPhoneNo = new CareSeeker_Phone_No(new_mobile);
                                            CareSeeker_Session_Management session_management = new CareSeeker_Session_Management(verifyOtp.this);
