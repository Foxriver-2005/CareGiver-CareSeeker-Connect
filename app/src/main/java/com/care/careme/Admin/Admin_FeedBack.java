...
import com.care.careme.Helpers.Admin_FeedBack_Adapter;
...
public class Admin_FeedBack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("CareGiver_Feedback");
