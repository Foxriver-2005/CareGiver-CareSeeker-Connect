...
public class CareGiver_Add_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caregiver_add_admin);
        ...
        Task<AuthResult> authResultTask = mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Users user = new Users(fullName,email, "offline", "CareGiver");
                            ...
                            FirebaseDatabase.getInstance("https://careconnect-2b4ca-default-rtdb.firebaseio.com/").getReference("Users")
                                    ...
                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful())
                                            {    progressBar.setVisibility(View.INVISIBLE);
                                                Toast.makeText(CareGiver_Add_Admin.this,"CareGiver has been registered successfully !",Toast.LENGTH_LONG).show();
//                                       mAuth.signOut();
//                                        startActivity(new Intent(Doctors_Add_Admin.this,DoctorsLogin.class));
                                            }
                                            else
                                            {   progressBar.setVisibility(View.INVISIBLE);
                                                Toast.makeText(CareGiver_Add_Admin.this,"Failed to Register. CareGiver already exists !",Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    });
                        }
